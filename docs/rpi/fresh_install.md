...
1. `wget https://raw.githubusercontent.com/DavesCodeMusings/school-coding-lab/main/rpi/fleet/quickstart_python_workstation.sh`
2. `bash ./quickstart_python_workstation.sh`
...
```
$ wget https://raw.githubusercontent.com/DavesCodeMusings/school-coding-lab/main/rpi/fleet/quickstart_python_workstation.sh
...
Saving to: ‘quickstart_python_workstation.sh’

admin@pi:~ $ bash ./quickstart_python_workstation.sh
